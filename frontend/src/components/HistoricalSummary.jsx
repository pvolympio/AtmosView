  ...
  return (
    <div className="glass-panel p-6 rounded-3xl border border-indigo-500/10 bg-indigo-500/5 shadow-xl w-full animate-fade-in">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-[10px] text-indigo-300 font-bold uppercase tracking-widest">Resumo Descritivo V2</span>
      </div>
      
      <div className="relative flex gap-3 items-start bg-slate-950/45 p-4 rounded-2xl border border-slate-900">
