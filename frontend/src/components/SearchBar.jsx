    ...
    <div className="relative w-full max-w-xl mx-auto z-50" ref={dropdownRef}>
      <div className="relative flex items-center">
        ...
        <input
          ...
          placeholder="Busque por uma cidade brasileira (Ex: Curitiba, Florianópolis)..."
      ...
      {isOpen && suggestions.length > 0 && (
        <ul className="absolute w-full mt-2 bg-slate-900 border border-slate-800/90 rounded-2xl shadow-2xl max-h-60 overflow-y-auto z-[999] backdrop-blur-lg overflow-hidden divide-y divide-slate-800/50">
          {suggestions.map((city, idx) => (
            <li key={idx}>
              ...
              >
                <div className="p-2 bg-slate-800/50 border border-slate-700/50 rounded-xl text-slate-400 group-hover:text-indigo-400">
                  <MapPin size={16} />
                </div>
                <div>
